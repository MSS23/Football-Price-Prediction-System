...
def linearRegression(playerName, dataframe):
    ...
    regressionModel = regr.predict(rowOfPlayer.drop(['short_name', 'value_eur'], axis=1))
...
def decisionTreeRegression(playerName, dataframe, depthValue):
    ...
    valueOfPlayer = tree_reg.predict(rowOfPlayer.drop(['short_name', 'value_eur'], axis=1))
...
def randomForestRegression(playerName, dataframe, treeValue, maxFeatureVal):
    ...
    predictedValue = regressor.predict(rowOfPlayer.drop(['short_name', 'value_eur'], axis=1))
...
def knnRegression(playerName, dataframe):
    ...
    predictedValue = model.predict(rowOfPlayer.drop(['short_name', 'value_eur'], axis=1))
